...
% .tex
\newcommand\Tests{Inhalt/Tests}
\newcommand\Errors{Inhalt/Fehler}
\newcommand\Changes{Inhalt/Aenderungen}
\newcommand\Exceptions{Inhalt/Ausnahmen}
\newcommand\Attachements{Inhalt/Anhang}
\newcommand\Media{\Attachements/Medien}


% Medien:

% Testknoten
\newcommand\AttachedTestknots{Inhalt/Anhang/Grafiken/Testknoten}

% Screenshots

\newcommand\Screencapturings{\Media/Aufnahmen}

% Screenshots von Aenderungen (vorher/nachher)

\newcommand\ChangeMedia{\Screencapturings/Aenderungen}

% Screenshots von Problemen

\newcommand\IssueMedia{\Screencapturings/Probleme}

% Screenshots von Testknoten

\newcommand\KnotMedia{\Screencapturings/Testknoten}

% Screenshots von Werkzeugen

\newcommand\Tools{\Screencapturings/Werkzeuge}

% Mock-Ups

\newcommand\MockUps{\Media/Mock-Ups}

% \\\


%
% Befehl, um das Bild eines Mauszeigers einzufügen.
%
\newcommand\mousecursor{\includegraphics[height=12pt]{\Media/Maus.jpg}}
...
\usepackage{grffile} % Keinen Dateinamen anzeigen
\usepackage{graphicx}
...
% Die einrückung eines neuen Paragrphen scheint nicht gewollt zu sein.
