...
\subsection{Automatische Testdurchläufe}
\label{Abschnitt:Programmfehler:Werkzeuge:Automatisiert}

Wir haben automatische Testdurchläufe, Berechnung von Statistiken, Berichterstellung und ein Benachrichtigungssystem bei Testfehlschlägen eingerichtet.
