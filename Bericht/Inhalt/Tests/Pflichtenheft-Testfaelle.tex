...
\section{Pflichtenheft-Referenzverweise}
\label{Abschnitt:Tests:Protokoll:Pflichtenheft-Verweise}

Die Tabelle \ref{Pflichtenheft-Referenzverweise} ordnet den im Pflichtenheft vor-spezifizierten Testfällen einen Verweis in das Testprotokoll, wo alle Tests beschrieben sind zu. Durch die Zuordnung wird zum Einen das Auffinden der Pflichttests erleichtert. Zum Anderen gibt sie während der Testphase eine ständige Übersicht zum aktuellen Fortschritt und verhindert, das bei einer hohen Anzahl von Testfällen etwas vergessen wird.
...
\begin{longtable}{p{0.5\hsize}p{0.275\hsize}p{0.275\hsize}}
	...
	\caption{Pflichtenheft-Referenzverweise\\~\\~\\}
	\label{Pflichtenheft-Referenzverweise} \\
