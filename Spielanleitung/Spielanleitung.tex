...
\item[R / F:] Bewegen die Kamera nach oben und unten.
...
\item[Strg + Linke Maustaste:] Ein Klick auf eine Kante fügt diese zur Selektion hinzu.
\item[Shift + Linke Maustaste:] Ein Klick auf eine Kante fügt alle von der zuletzt markierten bis zur aktuellen zur Selektion hinzu.
\end{description}
Ein Klick in den leeren Raum hebt alle Selektionen auf.
\item[Kanten Bewegen:] Durch gedrückt halten der linken Maustaste beginnen auf einer Selektierten Kante oder einem Pfeil, der sich im Menü einschalten lässt, lässt sich die Auswahl Bewegen. Sind mehrere Kanten markiert muss beim anklicken einer Kante Strg oder Shift gedrückt gehalten werden.
\item[Esc:] Öffnet im Spiel das Pausenmenü.
\item[C:] Ermöglicht das Färben markierter Kanten.
\item[N:] Ermöglicht das Erstellen von Flächen zwischen markierten Kanten.
